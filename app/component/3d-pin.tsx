...
export const PinContainer = ({
  ...
  return (
    ...
    >
      <div
        style={{
        width: "1200px", // Adjust the width here
          perspective: "1000px",
      ...
      >
        <div
          style={{
            transform: transform,
            width: "max-fill-available",
          }}
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl   transition duration-700 ease-in-out " 
        >
